<aside id="sidebar"
    ...
    <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
        ...
        @if(auth()->user()->rol === 'admin')
            ...
            <a href="/admin/configuracion" onclick="cerrarMenu()"
               class="flex items-center gap-3 px-4 py-3 rounded-xl transition font-medium
               {{ request()->is('admin/configuracion') ? 'bg-blue-600 text-white' : 'hover:bg-indigo-600 text-indigo-100' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        @if(auth()->user()->rol === 'usuario')
            ...
            <a href="/usuario/perfil" onclick="cerrarMenu()"
               class="flex items-center gap-3 px-4 py-3 rounded-xl transition font-medium
               {{ request()->is('usuario/perfil') ? 'bg-blue-600 text-white' : 'hover:bg-indigo-600 text-indigo-100' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">

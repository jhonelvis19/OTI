...
<div class="space-y-6">
    ...
    <!-- ENCABEZADO MIS INFORMES -->
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl sm:text-3xl font-extrabold text-slate-800 tracking-tight">Mis Informes</h1>
            <p class="text-xs sm:text-sm text-slate-400 mt-1">Actas e informes técnicos registrados directamente por su cuenta.</p>
        </div>
